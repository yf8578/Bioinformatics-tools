# Statistical helper functions for TANGO.
# These functions intentionally avoid heavy dependencies so that the package can
# run on standard R installations used in bioinformatics pipelines.
